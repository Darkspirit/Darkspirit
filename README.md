...
* Please be green on [hardenize.com](https://hardenize.com) and use IPv6 ([RPI](https://nlnetlabs.nl/projects/rpki/routinator/) for BGP), TLS 1.3, ECDSA DNSSEC, TLSA/DANE, CAA (`issue letsencrypt.org; validationmethods=dns-01`), DMARC (`p=reject`), SPF (`mx -all`), [HSTS](https://hstspreload.org/), [CSP](https://report-uri.com/home/generate).
<!--
